...
svgContainer.append("g").data(jsonCirclesJoined).append("rect")
						...
						.attr("y",function(d){ return d.y_axis-radius})
						.attr("rx",20)
						.attr("ry",20)
...
svgContainer.append("g").data(jsonCirclesJoined).append("text")
						...
						.attr("y",function(d){ return d.y_axis+radius/3})
						.text("Student Id : " + focusedStudent)
						.attr("font-size","20")
						.style("stroke","black");
...
circleAttributes = circles
                       ...
                       .attr("r", function (d,i) { if (d.y_axis==(5-focRank[0])*intervaly + topMargin) return 0; else return d.radius; })
...
svgContainer.append("g").selectAll(".stringLabels").data(jsonCirclesJoined).enter().append("text").attr("class","stringLabels")
        ...
        .text(function(d,i){ if (d.y_axis==(5-focRank[0])*intervaly + topMargin) {counter++; return null;} else {  d.label = peers[focusedStudent][i-counter]; return peers[focusedStudent][i-counter]; }})
